    ...
    public partial class AddIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Vehicles__476B54B23C011882", x => x.VehicleID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ViolationType = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Violatio__18B6DC289F2CEB85", x => x.ViolationID);
                    table.ForeignKey(
                        name: "FK_Vehicle_Violation",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Vehicles__026BC15CA00AA89E",
                table: "Vehicles",
                column: "LicensePlate",
                unique: true);
